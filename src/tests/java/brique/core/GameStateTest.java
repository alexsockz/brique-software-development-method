...
/**
 * Unit tests for the {@link GameState} class.  These tests focus on
 * initialisation, player management, pie rule toggling, game status
 * transitions and move history behaviour.  They are modelled after the
 * existing test patterns in the project but adapted for the current
 * implementation of {@code GameState}.
 */
