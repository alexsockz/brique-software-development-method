...
/**
 * Unit tests for the {@link GameEngine}.  These tests exercise the public
 * API of the engine, verifying that moves are validated and processed
 * correctly, the escort rule is honoured, the win condition is detected
 * and the pie rule behaves as specified.  They mirror the style of the
 * existing test suite for other components.
 */
